...
cat >>/etc/hosts<<EOF
192.168.56.110   k8s56master.example.com     k8s56master  km1
192.168.56.111   k8s56worker1.example.com    k8s56worker1 kw1
192.168.56.112   k8s56worker2.example.com    k8s56worker2 kw2
192.168.56.113   k8s56worker3.example.com    k8s56worker3 kw3
192.168.56.114   k8s56worker4.example.com    k8s56worker4 kw4
EOF
