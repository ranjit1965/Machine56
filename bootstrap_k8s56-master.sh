...
kubeadm init --apiserver-advertise-address=192.168.56.110 --pod-network-cidr=172.16.0.0/16 >> /root/kubeinit.log 2>/dev/null
...
echo "[TASK 6 install auto completion for ubuntu]"
sudo apt-get install bash-completion -y

echo "[TASK 7] Auto Complete"
